...
import BackArrow from 'svgs/subgraph-section/arrow-back.svg'
import ForwardArrow from 'svgs/subgraph-section/arrow-forward.svg'
import CopyToClipboard from 'svgs/subgraph-section/copy.svg'
...
const Query = styled.div`
  ...
  &::-webkit-scrollbar-thumb {
    border-radius: 4px;
    background-color: rgba(113, 134, 255, 0.3);
    box-shadow: 0 0 1px rgba(113, 134, 255, 0.3);
  }
`
...
const components = [
  {
    ...
    query:
      '{\n  lregistry(id: "0x66260c69d03837016d88c9877e61e08ef74c59f2") {\n      numberOfRegistered\n      items {\n        status\n        metadata {\n          props {\n          label\n          value\n          }\n         }\n     }\n  }\n}',
  ...
  },
  {
    ...
    query:
      '{\n  lregistry(id: "0xee1502e29795ef6c2d60f8d7120596abe3bad990") {\n      numberOfRegistered\n      items {\n        status\n        metadata {\n          props {\n          label\n          value\n          }\n        }\n     }\n  }\n}',
